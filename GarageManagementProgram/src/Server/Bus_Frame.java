...
public class Bus_Frame extends JFrame implements ActionListener,Runnable
{
	...
	private JButton bus_btn_1=new JButton("<html><body><center>"+sec_num+" 섹터"+"<br>차고 번호 : 1<br>공석</center></body></html>");
	private JButton bus_btn_2=new JButton("<html><body><center>"+sec_num+" 섹터"+"<br>차고 번호 : 2<br>공석</center></body></html>");
	private JButton bus_btn_3=new JButton("<html><body><center>"+sec_num+" 섹터"+"<br>차고 번호 : 3<br>공석</center></body></html>");
	private JButton bus_btn_4=new JButton("<html><body><center>"+sec_num+" 섹터"+"<br>차고 번호 : 4<br>공석</center></body></html>");
	private JButton bus_btn_5=new JButton("<html><body><center>"+sec_num+" 섹터"+"<br>차고 번호 : 5<br>공석</center></body></html>");
	private JButton bus_btn_6=new JButton("<html><body><center>"+sec_num+" 섹터"+"<br>차고 번호 : 6<br>공석</center></body></html>");
	private JButton bus_btn_7=new JButton("<html><body><center>"+sec_num+" 섹터"+"<br>차고 번호 : 7<br>공석</center></body></html>");
	private JButton bus_btn_8=new JButton("<html><body><center>"+sec_num+" 섹터"+"<br>차고 번호 : 8<br>공석</center></body></html>");
	...
	public String setString(int num,String str) {
		return"<html><body><center>"+sec_num+" 섹터"+"<br>차고 번호 : "+num+"<br>"+str+"</center></body></html>";
	}
	public void service(){
